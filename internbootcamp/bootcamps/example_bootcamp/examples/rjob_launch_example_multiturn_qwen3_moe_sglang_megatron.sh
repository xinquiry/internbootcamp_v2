...
experiment_name="examplebootcamp-grpo-multinode-Qwen3-sglang-megatron-${current_time}"
...
MODEL_PATH="/mnt/shared-storage-user/llmbr-share/chenyongkang/hf_hub/models--Qwen--Qwen3-235B-A22B-Instruct-2507-megatron"
