...
# 配置文件名
CONFIG_NAME="example_multiturn_w_tool_n_interaction_grpo"  
# 工具配置文件路径
## 远程工具配置文件路径
...
# 训练集数据路径
DATA_TRAIN_FILE_PATH="internbootcamp/bootcamps/example_bootcamp/data/example_arithmetic_w_toll_n_interaction/20250808161153_train.parquet"  
# 验证集数据路径
DATA_VAL_FILE_PATH="internbootcamp/bootcamps/example_bootcamp/data/example_arithmetic_w_toll_n_interaction/20250808161153_test.parquet"  
# 项目名称
PROJECT_NAME="example_bootcamp"  
# 实验名称
EXPERIMENT_NAME="example_bootcamp_arithmetic_w_tool_n_interaction_grpo_Qwen2.5-7B-1M"
# 生成时间戳
